...
namespace Collections
{
    class Program // this is internal by default
    {
        ...
        static void Arrays()
        {
            ...
            int[] intArray = new int[10]; // length 10 array (brackets, not parenthesis)
            ...
            // you can use a foreach loop with *anything* implementing the IEnumerable interface, which is
            // one of the most important interfaces in C#. (also used with LINQ!)

            // jagged / nested arrays
            int[][] arrayOfFourArrays = new int[4][];
            // this is now an array of four nulls
            //Console.WriteLine(arrayOfFourArrays[0][0]);
            ...
            // (never pre-optimize your code, write it the simple/understandable way first
            // and if necessary later, profile it, and optimize where actually useful.)
        ...
        static void Lists()
        {
            ...
            // that's more of a big deal for method signatures (parameteres,
            ...
            // Lists have dynamic length, grow and shrink as you add and remove values.
        ...
        static void Sets()
        {
            ...
            // like union, interaction, difference
        ...
        dict["Mexico"] = "Mexico City"; // insers/overwrites
        ...
        static void StringEquality()
        {
            ...
            // while .Equals is for "references and EQUIVALENT object"
            ...
            // for basically al reference types except string, == compares
